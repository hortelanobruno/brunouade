...
<!--        <div class="control-group <!?php echo form_error('administrar_torneos_cantidad_goles') ? 'error' : ''; ?>">
        ...
        <div class="control-group <?php echo form_error('administrar_torneos_cantidad_equipos_ascienden') ? 'error' : ''; ?>">
            ...
            <?php echo form_label('Group Size', 'administrar_torneos_group_size', array('class' => "control-label") ); ?>
            <div class="controls">
            ...
            <?php echo form_label('Cant Pass To Llave', 'administrar_torneos_cant_pass_to_llave', array('class' => "control-label") ); ?>
            <div class="controls">
