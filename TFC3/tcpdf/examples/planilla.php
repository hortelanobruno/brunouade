...
// create columns content
$left_column = '[LEFT COLUMN] left column left column'."\n";

$right_column = '[RIGHT COLUMN] right column right column right column right'."\n";
...
$pdf->MultiCell(100, 0, $left_column, 0, 'J', 1, 0, '', '', true, 0, false, true, 0);
...
$pdf->MultiCell(100, 0, $right_column, 0, 'J', 1, 1, '', '', true, 0, false, true, 0);
