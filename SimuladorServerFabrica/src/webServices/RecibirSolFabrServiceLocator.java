...
public class RecibirSolFabrServiceLocator extends org.apache.axis.client.Service implements webServices.RecibirSolFabrService {
    ...
    public webServices.RecibirSolFabr getRecibirSolFabr() throws javax.xml.rpc.ServiceException {
    ...
    public webServices.RecibirSolFabr getRecibirSolFabr(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            webServices.RecibirSolFabrSoapBindingStub _stub = new webServices.RecibirSolFabrSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (webServices.RecibirSolFabr.class.isAssignableFrom(serviceEndpointInterface)) {
                webServices.RecibirSolFabrSoapBindingStub _stub = new webServices.RecibirSolFabrSoapBindingStub(new java.net.URL(RecibirSolFabr_address), this);
                _stub.setPortName(getRecibirSolFabrWSDDServiceName());
                return _stub;
            }
        }
