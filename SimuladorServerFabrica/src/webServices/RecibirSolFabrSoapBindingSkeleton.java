...
public class RecibirSolFabrSoapBindingSkeleton implements webServices.RecibirSolFabr, org.apache.axis.wsdl.Skeleton {
    private webServices.RecibirSolFabr impl;
    ...
    */
    ...
    static {
        ...
        _oper.setElementQName(new javax.xml.namespace.QName("urn:webServices", "recibirSolFabr"));
        _oper.setSoapAction("");
    ...
    public RecibirSolFabrSoapBindingSkeleton() {
        this.impl = new webServices.RecibirSolFabrSoapBindingImpl();
    }

    public RecibirSolFabrSoapBindingSkeleton(webServices.RecibirSolFabr impl) {
        this.impl = impl;
    }
