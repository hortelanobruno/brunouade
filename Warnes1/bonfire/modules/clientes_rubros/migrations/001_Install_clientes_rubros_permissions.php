...
class Migration_Install_clientes_rubros_permissions extends Migration {

	// permissions to migrate
	private $permission_values = array(
		array('name' => 'Clientes_Rubros.Content.View', 'description' => '', 'status' => 'active',),
		array('name' => 'Clientes_Rubros.Content.Create', 'description' => '', 'status' => 'active',),
		array('name' => 'Clientes_Rubros.Content.Edit', 'description' => '', 'status' => 'active',),
		array('name' => 'Clientes_Rubros.Content.Delete', 'description' => '', 'status' => 'active',),
	);
