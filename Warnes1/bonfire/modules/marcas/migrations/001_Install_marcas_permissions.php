...
class Migration_Install_marcas_permissions extends Migration {

	// permissions to migrate
	private $permission_values = array(
		array('name' => 'Marcas.Content.View', 'description' => '', 'status' => 'active',),
		array('name' => 'Marcas.Content.Create', 'description' => '', 'status' => 'active',),
		array('name' => 'Marcas.Content.Edit', 'description' => '', 'status' => 'active',),
		array('name' => 'Marcas.Content.Delete', 'description' => '', 'status' => 'active',),
	);
