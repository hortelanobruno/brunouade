...
class Migration_Install_clientes_zonas_permissions extends Migration {

	// permissions to migrate
	private $permission_values = array(
		array('name' => 'Clientes_Zonas.Content.View', 'description' => '', 'status' => 'active',),
		array('name' => 'Clientes_Zonas.Content.Create', 'description' => '', 'status' => 'active',),
		array('name' => 'Clientes_Zonas.Content.Edit', 'description' => '', 'status' => 'active',),
		array('name' => 'Clientes_Zonas.Content.Delete', 'description' => '', 'status' => 'active',),
	);
