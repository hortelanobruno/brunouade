...
class Migration_Install_banners_types_permissions extends Migration {

	// permissions to migrate
	private $permission_values = array(
		array('name' => 'Banners_Types.Content.View', 'description' => '', 'status' => 'active',),
		array('name' => 'Banners_Types.Content.Create', 'description' => '', 'status' => 'active',),
		array('name' => 'Banners_Types.Content.Edit', 'description' => '', 'status' => 'active',),
		array('name' => 'Banners_Types.Content.Delete', 'description' => '', 'status' => 'active',),
	);
