...
class Migration_Install_zonas_permissions extends Migration {

	// permissions to migrate
	private $permission_values = array(
		array('name' => 'Zonas.Content.View', 'description' => '', 'status' => 'active',),
		array('name' => 'Zonas.Content.Create', 'description' => '', 'status' => 'active',),
		array('name' => 'Zonas.Content.Edit', 'description' => '', 'status' => 'active',),
		array('name' => 'Zonas.Content.Delete', 'description' => '', 'status' => 'active',),
	);
