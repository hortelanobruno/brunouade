...
class Migration_Install_fotos_permissions extends Migration {

	// permissions to migrate
	private $permission_values = array(
		array('name' => 'Fotos.Content.View', 'description' => '', 'status' => 'active',),
		array('name' => 'Fotos.Content.Create', 'description' => '', 'status' => 'active',),
		array('name' => 'Fotos.Content.Edit', 'description' => '', 'status' => 'active',),
		array('name' => 'Fotos.Content.Delete', 'description' => '', 'status' => 'active',),
	);
