...
class Migration_Install_clientes_permissions extends Migration {

	// permissions to migrate
	private $permission_values = array(
		array('name' => 'Clientes.Content.View', 'description' => '', 'status' => 'active',),
		array('name' => 'Clientes.Content.Create', 'description' => '', 'status' => 'active',),
		array('name' => 'Clientes.Content.Edit', 'description' => '', 'status' => 'active',),
		array('name' => 'Clientes.Content.Delete', 'description' => '', 'status' => 'active',),
	);
