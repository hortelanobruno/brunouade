...
class Migration_Install_noticias_fotos_permissions extends Migration {

	// permissions to migrate
	private $permission_values = array(
		array('name' => 'Noticias_Fotos.Content.View', 'description' => '', 'status' => 'active',),
		array('name' => 'Noticias_Fotos.Content.Create', 'description' => '', 'status' => 'active',),
		array('name' => 'Noticias_Fotos.Content.Edit', 'description' => '', 'status' => 'active',),
		array('name' => 'Noticias_Fotos.Content.Delete', 'description' => '', 'status' => 'active',),
	);
