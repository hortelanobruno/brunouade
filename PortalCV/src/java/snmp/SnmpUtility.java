...
public class SnmpUtility {
    ...
    public List<VariableBinding> getBulk(OID oid, String community) {
        List<VariableBinding> ret = new ArrayList<VariableBinding>();
    ...
    public List<VariableBinding> getSubtree(OID oid, String community, Integer repetitions) {
        List<VariableBinding> ret = new ArrayList<VariableBinding>();
        ...
        try {
            ...
            tree.setMaxRepetitions(repetitions);
            List lista = null;
            lista = tree.getSubtree(target, oid);
            TreeEvent tEvent;
            for (Object a : lista) {
                tEvent = (TreeEvent) a;
                if (tEvent != null && tEvent.getVariableBindings() != null) {
                    for (VariableBinding vb : tEvent.getVariableBindings()) {
                        ret.add(vb);
                    }
                }
            }
