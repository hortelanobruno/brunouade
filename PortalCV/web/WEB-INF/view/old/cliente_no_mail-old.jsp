    ...
    <body onLoad="javascript:hideDiv(); javascript:focusText();">
        <div class="landscape" id="landscape">
            <div id="contenedor" style="width:100%; position:relative; top:-10px;" align="center">
                <img src="/img/fondoinicio_03.jpg" width="873" height="650" border="0" usemap="#Map" />
        ...
        <div class="portrait" id="portrait">
            <div id="contenedor" style="width:100%; position:relative; top:-10px;" align="center">
                <img src="/img/vert_fondoinicio03.jpg" width="900" height="1172" border="0" usemap="#Map2" /></div>
