...
<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
    <fieldset>
                ...
                <?php if (isset($equipos)) { ?>
                    <select id="jugadores_idequipo" name="jugadores_idequipo">
                        <?php foreach ($equipos as $equipo): ?>
                            <?php if ($equipo['id'] === $jugadores['idequipo']) : ?>
        ...
        <div class="form-actions">
            <br/>
            <input type="submit" name="save" class="btn btn-primary" value="Edit Jugadores" />
    ...
    <?php if ($this->auth->has_permission('Jugadores.Content.Delete')) : ?>
            ...
            or <button type="submit" name="delete" class="btn btn-danger" id="delete-me" onclick="return confirm('<?php e(js_escape(lang('jugadores_delete_confirm'))); ?>')">
            <i class="icon-trash icon-white">&nbsp;</i>&nbsp;<?php echo lang('jugadores_delete_record'); ?>
            </button>
