...
<!--                <input id="administrar_torneos_categoria" type="text" name="administrar_torneos_categoria" maxlength="11" value="<!?php echo set_value('administrar_torneos_categoria', isset($administrar_torneos['categoria']) ? $administrar_torneos['categoria'] : ''); ?>"  />-->
                ...
                <div class="control-group <?php echo form_error('administrar_torneos_logo_grande') ? 'error' : ''; ?>">
                ...
                <div class="control-group <?php echo form_error('administrar_torneos_cantidad_equipos_descienden') ? 'error' : ''; ?>">
                ...
                <div class="control-group <?php echo form_error('administrar_torneos_archivado') ? 'error' : ''; ?>">
                ...
                <div class="control-group <?php echo form_error('administrar_torneos_ida_y_vuelta_grupo') ? 'error' : ''; ?>">
                ...
                <div class="control-group <?php echo form_error('administrar_torneos_ida_y_vuelta_llave') ? 'error' : ''; ?>">
                ...
                <div class="control-group <?php echo form_error('administrar_torneos_group_size') ? 'error' : ''; ?>">
                ...
                <div class="control-group <?php echo form_error('administrar_torneos_cant_pass_to_llave') ? 'error' : ''; ?>">
            ...
            <div id="tabs-2">
                <div style="display: block">
                    <div style="display: inline-block">
                        <select id="equipoelegidos" name="equipoelegidos[]" multiple size="20" onchange="changeMessageEquiposSelected()">
                            <?php if (isset($equipos)) { ?>
                                <?php foreach ($equipos as $equipo): ?>
                                    <?php if (isSelected($equiposseleccionados, $equipo['id'])) : ?>
            ...
            <div id="tabs-3">
                ...
                <div class="control-group <?php echo form_error('administrar_torneos_reglamento') ? 'error' : ''; ?>">
...
function isSelected($equiposseleccionados, $idequipo) {
    if (isset($equiposseleccionados)) {
        foreach ($equiposseleccionados as $equiposelected) {
            if ($equiposelected['id'] === $idequipo)
                return true;
        }
    }else {
        return false;
