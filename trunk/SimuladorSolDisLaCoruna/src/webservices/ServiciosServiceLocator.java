...
public class ServiciosServiceLocator extends org.apache.axis.client.Service implements webservices.ServiciosService {
    ...
    private java.lang.String Servicios_address = "http://192.168.9.127:8080/axis/services/Servicios";
    ...
    public webservices.Servicios getServicios() throws javax.xml.rpc.ServiceException {
    ...
    public webservices.Servicios getServicios(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            webservices.ServiciosSoapBindingStub _stub = new webservices.ServiciosSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (webservices.Servicios.class.isAssignableFrom(serviceEndpointInterface)) {
                webservices.ServiciosSoapBindingStub _stub = new webservices.ServiciosSoapBindingStub(new java.net.URL(Servicios_address), this);
                _stub.setPortName(getServiciosWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("urn:webservices", "ServiciosService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("urn:webservices", "Servicios"));
        }
