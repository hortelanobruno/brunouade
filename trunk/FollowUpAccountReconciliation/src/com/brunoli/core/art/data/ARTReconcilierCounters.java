 ...
 * @author brunoli
 */
public class ARTReconcilierCounters {

    private Map<String, Integer> reconStatusCounts;
    private Integer total = 0;
    private final String completedReconStatusName = "Reviewed and Reconciled";

    public ARTReconcilierCounters(List<String> reconStatusTypes) {
