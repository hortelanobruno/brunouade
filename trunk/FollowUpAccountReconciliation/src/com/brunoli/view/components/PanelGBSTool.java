...
import com.brunoli.core.gbs.GBSCore;
import java.io.File;
 ...
 * @author brunoli
 */
public class PanelGBSTool extends javax.swing.JPanel {
    ...
    private final String artConfigFile = "./gbs.properties";
    private MainView main;
    private GBSCore artCore = new GBSCore();
    private JFileChooser chooser;

    /**
     * Creates new form PanelARTTool
     */
    public PanelGBSTool(MainView main) {
        initComponents();
        this.main = main;
    ...
    private void initComponents() {
        ...
        jPanel7Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {tfColumnReconciler2, tfNamesPageNumber});
    ...
    private void buttonRunActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonRunActionPerformed
        if (validateData()) {
            try {
                ...
                artCore.generateOutput(selectedDatabaseFileName, selectedNamesFileName, selectedOutputFileName, dfColReconciler, dfColReconStatus, dfColLocalME, nfColReconciler,
