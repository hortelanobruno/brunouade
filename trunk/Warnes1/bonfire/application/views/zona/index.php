            ...
            <div class="col1">
                <div class="boxAllCategory">
                    <div class="zonas">
                        ...
                        $index = '';
                        $cantpercolumn = count($allzonas);
                        $cantpercolumn2 = count($allzonas);
                        foreach ($allzonas as $zona):
                            $a = substr(strtr($zona['descripcion'], $normalizeChars), 0, 1);
                            if ($index <> $a) {
                        ...
                        ?>
                        <div class="body">
                            <div class="header"><h1>Listado de zonas</h1></div>
                            <div class="main">
                                <div class="content-1">
                                    <div class="border2">
                                        <?php
                                        ...
                                        while ($i < $cantpercolumn && $j < $cantpercolumn2) {
                                            $a = substr(strtr($allzonas[$j]['descripcion'], $normalizeChars), 0, 1);
                                            if ($index <> $a) {
                                            ...
                                            ?>
                                            <a href="/zona/<?php echo $allzonas[$j]['idzona'] ?>"><?php echo strtoupper($allzonas[$j]['descripcion']) ?></a><br/>
                                            <?php
                                            $i++;
                                            $j++;
                                        }
