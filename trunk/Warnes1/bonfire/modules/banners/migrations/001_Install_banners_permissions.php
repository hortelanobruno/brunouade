...
class Migration_Install_banners_permissions extends Migration {

	// permissions to migrate
	private $permission_values = array(
		array('name' => 'Banners.Content.View', 'description' => '', 'status' => 'active',),
		array('name' => 'Banners.Content.Create', 'description' => '', 'status' => 'active',),
		array('name' => 'Banners.Content.Edit', 'description' => '', 'status' => 'active',),
		array('name' => 'Banners.Content.Delete', 'description' => '', 'status' => 'active',),
	);
