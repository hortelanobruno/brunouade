...
class Migration_Install_clientes_marcas_permissions extends Migration {

	// permissions to migrate
	private $permission_values = array(
		array('name' => 'Clientes_Marcas.Content.View', 'description' => '', 'status' => 'active',),
		array('name' => 'Clientes_Marcas.Content.Create', 'description' => '', 'status' => 'active',),
		array('name' => 'Clientes_Marcas.Content.Edit', 'description' => '', 'status' => 'active',),
		array('name' => 'Clientes_Marcas.Content.Delete', 'description' => '', 'status' => 'active',),
	);
