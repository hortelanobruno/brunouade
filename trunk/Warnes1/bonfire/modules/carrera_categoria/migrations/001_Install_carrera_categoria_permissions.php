...
class Migration_Install_carrera_categoria_permissions extends Migration {

	// permissions to migrate
	private $permission_values = array(
		array('name' => 'Carrera_Categoria.Content.View', 'description' => '', 'status' => 'active',),
		array('name' => 'Carrera_Categoria.Content.Create', 'description' => '', 'status' => 'active',),
		array('name' => 'Carrera_Categoria.Content.Edit', 'description' => '', 'status' => 'active',),
		array('name' => 'Carrera_Categoria.Content.Delete', 'description' => '', 'status' => 'active',),
	);
