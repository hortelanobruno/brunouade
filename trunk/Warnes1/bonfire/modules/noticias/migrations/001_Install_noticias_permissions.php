...
class Migration_Install_noticias_permissions extends Migration {

	// permissions to migrate
	private $permission_values = array(
		array('name' => 'Noticias.Content.View', 'description' => '', 'status' => 'active',),
		array('name' => 'Noticias.Content.Create', 'description' => '', 'status' => 'active',),
		array('name' => 'Noticias.Content.Edit', 'description' => '', 'status' => 'active',),
		array('name' => 'Noticias.Content.Delete', 'description' => '', 'status' => 'active',),
	);
