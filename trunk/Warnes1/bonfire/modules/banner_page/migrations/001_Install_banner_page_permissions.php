...
class Migration_Install_banner_page_permissions extends Migration {

	// permissions to migrate
	private $permission_values = array(
		array('name' => 'Banner_Page.Content.View', 'description' => '', 'status' => 'active',),
		array('name' => 'Banner_Page.Content.Create', 'description' => '', 'status' => 'active',),
		array('name' => 'Banner_Page.Content.Edit', 'description' => '', 'status' => 'active',),
		array('name' => 'Banner_Page.Content.Delete', 'description' => '', 'status' => 'active',),
	);
