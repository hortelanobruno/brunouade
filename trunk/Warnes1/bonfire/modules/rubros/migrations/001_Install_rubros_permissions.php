...
class Migration_Install_rubros_permissions extends Migration {

	// permissions to migrate
	private $permission_values = array(
		array('name' => 'Rubros.Content.View', 'description' => '', 'status' => 'active',),
		array('name' => 'Rubros.Content.Create', 'description' => '', 'status' => 'active',),
		array('name' => 'Rubros.Content.Edit', 'description' => '', 'status' => 'active',),
		array('name' => 'Rubros.Content.Delete', 'description' => '', 'status' => 'active',),
	);
